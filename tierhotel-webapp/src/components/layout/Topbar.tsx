  ...
  return (
    <header className="w-full h-16 sticky top-0 z-40 bg-[#f8f9fa]/80 backdrop-blur-xl flex justify-between items-center px-12 ml-auto">
      ...
      <div className="flex items-center gap-8">
        <div className="flex items-center gap-6">
          <span className="material-symbols-outlined text-slate-400 hover:text-[#904d00] cursor-pointer transition-colors">notifications</span>
          <span className="material-symbols-outlined text-slate-400 hover:text-[#904d00] cursor-pointer transition-colors">help_outline</span>
          <span className="material-symbols-outlined text-slate-400 hover:text-[#904d00] cursor-pointer transition-colors">account_circle</span>
        </div>
